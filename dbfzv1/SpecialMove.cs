...
namespace dbfzv1
{
    public class SpecialMove : Move
    {
        ...
        public SpecialMove()
        {
            name = "Unnamed special move";
        }

        public SpecialMove(string n, string inp, string m, string d, string g, string s, string act, string r, string adv, string i, string no) //11 inputs
        {
            name = n;
            input = inp;
            meter = m;
